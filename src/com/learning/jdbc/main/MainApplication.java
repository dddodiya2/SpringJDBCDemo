...
public class MainApplication {
	...
	public static void main(String[] args) {
		...
		//String sql = "insert into Employee values(1, 'Ishwari', 'Java Developer', 90000.00, 5 )";
		
		Employee e1 = new Employee(1, "Ishwari", "Java Dev", 99000.00, 5);
		employeeDao.addEmployee(e1);
		Employee e2 = new Employee(2, "Anjali", "Spring Dev", 98000.00, 8);
		...
		System.out.println("Calling getAllEmployee method ");
